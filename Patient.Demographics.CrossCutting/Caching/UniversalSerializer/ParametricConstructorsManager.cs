...
namespace UniversalSerializerLib3
{
	...
	internal static class ParametricConstructorsManager
	{
		...
		static internal ParametricConstructorDescriptor GetTypeParamDescriptorFromCache(Type type)
		{
			...
			paramDescriptorCache.TryAdd(type, d);

			return d.Value;
		}

		static ConcurrentDictionary<Type, Contains<ParametricConstructorDescriptor>> paramDescriptorCache =
	new ConcurrentDictionary<Type, Contains<ParametricConstructorDescriptor>>();
