	...
	public class ModifiersAssembly
	{
		...
		public static ModifiersAssembly GetModifiersAssembly(Assembly assembly)
		{
			...
			if (!_ModifiersAssemblyCache.TryGetValue(assembly, out ret))
			{
				...
				_ModifiersAssemblyCache.TryAdd(assembly, ret);
			}
			return ret;
		}
		static ConcurrentDictionary<Assembly, ModifiersAssembly> _ModifiersAssemblyCache = new ConcurrentDictionary<Assembly, ModifiersAssembly>();
