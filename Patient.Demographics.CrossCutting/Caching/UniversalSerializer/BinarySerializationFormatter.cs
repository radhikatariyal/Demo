...
namespace UniversalSerializerLib3
{
	...
	internal sealed class BinarySerializationFormatter : SerializationFormatter
	{
		...
		internal override bool ChannelEnterElementAndWriteValue(ref ChannelInfos channelInfos, Element element, out bool TheElementHaveAttributes, TypeCode TypeIndex, object Value,bool IsStructure)
			{
